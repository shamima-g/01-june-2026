...
|---|---|
| **Missing** | Output: "No connectivity capture found in the manifest — going live without verification." Skip to Step 2. |
...
Read `generated-docs/specs/project-brief.md` and `generated-docs/specs/api-spec.yaml`.
